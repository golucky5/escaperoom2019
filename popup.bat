...
pause
set "file=C:\Users\lunaxdab\Desktop\usb files for escape room\hackingsound.wav"
...
set "file=C:\Users\lunaxdab\Desktop\usb files for escape room\typewriter.mp3"
( echo Set Sound = CreateObject("WMPlayer.OCX.7"^)
  echo Sound.URL = "%file%"
  echo Sound.Controls.play
  echo do while Sound.currentmedia.duration = 0
...
start iexplore.exe file:///d:/secret2.html
start iexplore.exe file:///d:/secret2.html
start iexplore.exe file:///d:/secret2.html
start iexplore.exe file:///d:/secret2.html
start iexplore.exe file:///d:/secret2.html
